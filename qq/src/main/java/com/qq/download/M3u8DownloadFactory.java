package com.qq.download;

import com.qq.Exception.M3u8Exception;
import com.qq.listener.DownloadListener;
import com.qq.utils.Constant;
import com.qq.utils.Log;
import com.qq.utils.MediaFormat;
import com.qq.utils.StringUtils;
...
public class M3u8DownloadFactory {
    ...
    public static class M3u8Download {
        ...
        private static final String FILESEPARATOR = Constant.FILESEPARATOR;
        //要下载的m3u8链接
        ...
        private Thread getThread(String urls, int i) {
            ...
            return new Thread(() -> {
                ...
                File file2 = new File(hlsDir + FILESEPARATOR + i + ".xy");
                if (file2.exists())
                    file2.delete();
                ...
                while (count <= retryCount) {
                    try {
                        ...
                        File file = new File(hlsDir + FILESEPARATOR + i + ".xyz");
        ...
        private void checkField() {
            ...
            if (StringUtils.isEmpty(dir))
                throw new M3u8Exception("MP4视频存储目录不能为空！");
            if (StringUtils.isEmpty(hlsDir))
                throw new M3u8Exception("M3U8视频存储目录不能为空！");
